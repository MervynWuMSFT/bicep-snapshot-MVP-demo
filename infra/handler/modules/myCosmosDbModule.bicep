import { ResourceInfo, CosmosDbIngress, CosmosDbConfigs } from '../../shared/types.bicep'
...
param cosmosDbConfigs CosmosDbConfigs
...
resource cosmosAccount 'Microsoft.DocumentDB/databaseAccounts@2023-03-15' = {
  ...
  properties: {
    ...
    locations: [
      {
        failoverPriority: 0
        isZoneRedundant: cosmosDbConfigs.isZoneRedundant
    ...
    backupPolicy: cosmosDbConfigs.enableContinuousBackup ? {
      type: 'Continuous'
    } : {
      type: 'Periodic'
...
resource database 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases@2023-03-15' = {
  ...
  properties: {
    ...
    options: {
      autoscaleSettings: {
        maxThroughput: cosmosDbConfigs.sqlDatabaseThroughput
      }
    }
  }
}
