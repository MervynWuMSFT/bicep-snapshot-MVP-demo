import { ContainerImage, CosmosDbIngress, CopilotHandlerConfig, ResourceInfo, CosmosDbConfigs } from '../shared/types.bicep'
...
module cosmosDb 'modules/mycosmosDbModule.bicep' = {
  name: 'cosmosDb'
  params: {
    ...
    cosmosDbConfigs: cosmosDbConfigs
  }
}
